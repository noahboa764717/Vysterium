...
class ChromeTabs {
  ...
  addTab(tabProperties) {
    if(tabProperties.url !== "./newtab.html" && !tabProperties.title) tabProperties.title = tabProperties.url;
    if(tabProperties.url !== "./newtab.html") tabProperties.favicon = `https://www.google.com/s2/favicons?domain=${tabProperties.url}`;
