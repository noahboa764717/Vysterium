...
console.log(link);
  ...
  // }
  parent.document.getElementById("frame").src="selfindex$config.prefix"+selfindex$config.encodeUrl(link);
};
...
const database = [
    ...
    },
    {
        ...
        path: "/games/tower-building/index.html"
    },
    {
        name: "Bullet Bill",
        type: "flash",
        icon: "./game-imgs/bulletbill.png",
        path: "/games/flash/index.html?swf=bullet_bill_26.swf"
    },
    {
        name: "Portal 2D",
        type: "flash",
        icon: "./game-imgs/portal.png",
        path: "/games/flash/index.html?swf=portal2d.swf"
    },
    {
        name: "Alien Hominid",
        type: "flash",
        icon: "./game-imgs/AlienHominid.png",
        path: "/games/flash/index.html?swf=alien.swf"
    },
    {
        name: "Achievement+",
        type: "flash",
        icon: "./game-imgs/achievement.png",
        path: "/games/flash/index.html?swf=achievement-unlocked.swf"
    },
    {
    ...
    },
    {
        ...
        path: "/games/cookie/index.html"
    },
    {
        name: "Moto X3M",
        type: "html",
        icon: "./game-imgs/moto.png",
        path: "/games/moto/index.html"
    },
    {
        name: "Vex 4",
        type: "html",
    ...
    },
    {
        ...
        path: "/games/rooftop-snipers/index.html"
    },
    {
        name: "Slope",
        type: "html",
    ...
    },
    {
        ...
        path: "/games/a-dark-room/index.html"
    },
    {
        name: "Age Of War",
        type: "flash",
        icon: "./game-imgs/war.png",
        path: "/games/flash/index.html?swf=age-of-war.swf"
    },
    {
        name: "Binding of Isaac",
        type: "flash",
        icon: "./game-imgs/isaac.png",
        path: "/games/flash/index.html?swf=isaac.swf"
    },
    {
        name: "Impossible Quiz 2",
        type: "flash",
        icon: "./game-imgs/quiz2.png",
        path: "/games/flash/index.html?swf=quiz2.swf"
    },
    {
        name: "Real Estate Tycoon",
        type: "flash",
        icon: "./game-imgs/tycoon.png",
        path: "/games/flash/index.html?swf=tycoon.swf"
    },
    {
        name: "Warfare 1944",
        type: "flash",
        icon: "./game-imgs/warfare1944.png",
        path: "/games/flash/index.html?swf=warfare1944.swf"
    },
]
