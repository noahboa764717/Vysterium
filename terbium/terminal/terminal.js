    ...
    if (e.key === "Enter") {
        ...
        if(command.textContent.split(" ")[0] === ("logout")) {
            if(localStorage.getItem("pass") === null || localStorage.getItem("pass") === "none") {
                ...
                if(password === "y") {
                    ...
                    localStorage.setItem("pass", __uv$config.encodeUrl(newPassword));
                    output.innerHTML = `
                        <p>Password set</p>
                        <div class="linebreak"></div>
                    `;
        ...
        if(command.textContent.split(" ")[0] === ("sp")) {
            ...
            if(text === "none" || text === "") {
                ...
                localStorage.setItem("pass", __uv$config.encodeUrl(text));
        ...
        if(command.textContent.split(" ")[0] === ("-video")) {
            ...
            if(text.includes("https://" || "http://")) {
                ...
                if(text.startsWith("https://imgur.com/")) {
                    ...
                    iframe.src = __uv$config.prefix + "/" + __uv$config.encodeUrl(text);
